...
export const varianceAffixes: VarianceAffixDefinition[] = [
  ...
  { key: "lifeLeech", label: "Life Leech", itemTypes: ["ring"], valueType: "number", impactTier: "secondary", evaluatorWeight: 2 },
  ...
  { key: "requirementsReduction", label: "-15 Requirements", itemTypes: ["jewel"], valueType: "number", impactTier: "secondary", evaluatorWeight: 2 },
